...
import nothing.lib.item.ItemBlockBase;
import nothing.lib.render.DefaultBlockRenderer;
import nothing.lib.render.IBlockRenderingHandler;
import nothing.lib.texture.IIconBlock;
import nothing.lib.texture.IIconRegister;
import nothing.lib.tile.TileEntityBase;
import nothing.lib.util.CommonUtils;
import nothing.lib.util.HideInventory;
...
public class BlockBase<T extends TileEntity> extends Block implements ITileEntityProvider, IIconBlock {
    ...
    public BlockBase(String modid, String blockName, Material material, MapColor mapColor) {
        ...
        VoidLib.PROXY.handleBlock(this);
